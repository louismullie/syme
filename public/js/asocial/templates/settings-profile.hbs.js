...
Handlebars.templates['settings-profile.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  return buffer;});
Handlebars.registerPartial('settings-profile.hbs', Handlebars.templates['settings-profile.hbs']);
