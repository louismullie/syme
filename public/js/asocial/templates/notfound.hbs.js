...
Handlebars.templates['notfound.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  buffer += escapeExpression(stack1) + "\n        </a>\n      </p>\n    </div>\n  </div>\n</div>\n";
  return buffer;});
Handlebars.registerPartial('notfound.hbs', Handlebars.templates['notfound.hbs']);
