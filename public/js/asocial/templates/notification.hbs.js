...
Handlebars.templates['notification.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  buffer += escapeExpression(stack1) + "\n  </p>\n</div>\n";
  return buffer;});
Handlebars.registerPartial('notification.hbs', Handlebars.templates['notification.hbs']);
