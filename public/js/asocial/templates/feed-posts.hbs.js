...
Handlebars.templates['feed-posts.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program2(depth0,data) {
  ...
  buffer += " ";
  stack1 = depth0;
  stack1 = self.invokePartial(partials['feed-post.hbs'], 'feed-post.hbs', stack1, helpers, partials);;
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += " ";
  return buffer;}
...
function program4(depth0,data) {
  ...
  buffer += "\n";
  return buffer;});
Handlebars.registerPartial('feed-posts.hbs', Handlebars.templates['feed-posts.hbs']);
