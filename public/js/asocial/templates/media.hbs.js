...
Handlebars.templates['media.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  buffer += "\n  :\n  ";
  stack1 = depth0;
  stack1 = self.invokePartial(partials['feed-attachment-encrypted'], 'feed-attachment-encrypted', stack1, helpers, partials);;
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</p>\n";
  return buffer;}
...
function program4(depth0,data) {
  ...
  stack1 = depth0;
  stack1 = self.invokePartial(partials['feed-attachment-embed'], 'feed-attachment-embed', stack1, helpers, partials);;
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n";
  return buffer;});
