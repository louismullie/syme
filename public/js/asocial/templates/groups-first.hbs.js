...
Handlebars.templates['groups-first.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
Handlebars.registerPartial('groups-first.hbs', Handlebars.templates['groups-first.hbs']);
