...
Handlebars.templates['post.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program6(depth0,data) {
  ...
  buffer += " ";
  stack1 = depth0;
  stack1 = self.invokePartial(partials['feed-attachment'], 'feed-attachment', stack1, helpers, partials);;
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += " ";
  return buffer;}
...
function program10(depth0,data) {
  ...
  stack1 = depth0;
  stack1 = self.invokePartial(partials['feed-comments'], 'feed-comments', stack1, helpers, partials);;
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n    </div>\n  </div>\n</div>\n";
  return buffer;});
