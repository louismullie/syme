...
Handlebars.templates['error-forbidden.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  buffer += escapeExpression(stack1) + "\n        </a>\n      </p>\n    </div>\n  </div>\n</div>\n";
  return buffer;});
Handlebars.registerPartial('error-forbidden.hbs', Handlebars.templates['error-forbidden.hbs']);
