...
Handlebars.templates['panel.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program4(depth0,data) {
  ...
  buffer += "\n  <!-- / Userlist -->\n  ";
  stack1 = depth0;
  stack1 = self.invokePartial(partials['feed-users'], 'feed-users', stack1, helpers, partials);;
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</div>\n";
  return buffer;});
