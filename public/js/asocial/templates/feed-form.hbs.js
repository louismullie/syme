...
Handlebars.templates['feed-form.hbs'] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  return buffer;});
Handlebars.registerPartial('feed-form.hbs', Handlebars.templates['feed-form.hbs']);
