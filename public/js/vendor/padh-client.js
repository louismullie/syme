...
PAKDHClient = function (password, group) {
  ...
  // Hash the password and convert to Big Integer.
  var passwordHash = calcSHA1(this.password);
  this.passwordBn = new BigInteger(passwordHash, 16);
...
PAKDHClient.prototype = {
  ...
  generateA: function () {
    var a = this.random();
    return this.modPow(a);  
  },
  
  generateB: function () {
    var b = this.random();
    return this.modPow(b);
  },
  
  calculateX: function (A) {
    return this.passwordBn.multiply(A);
  },
  ...
  calculateXab: function (Q) {
    ...
    return Q.divide(this.passwordBn);
    
  },
  
  calculateY: function (B) {
    
    var Y = this.passwordBn.multiply(B);
  ...
  calculateYba: function (B) {
    ...
    return Y.divide(this.passwordBn);
  ...
  /*
   * Group parameters taken from SRP, composed of N (
   * hexadecimal prime value) and g (decimal group generator).
   *
